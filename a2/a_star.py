...
class Node:
    def __init__(self, data, level, fval):
        ...
        self.data = data  # data in the node is the puzzle
        self.level = level  # level of node in the tree
        self.fval = fval  # f = g + h, g = level of node, h = no of misplaced tiles

    def generate_child(self):
        """ Generate child nodes from the given node by moving the blank space
            either in the four directions {up,down,left,right} """
        x, y = self.find(self.data, '_')  # to get x&y coordinates, defined below
